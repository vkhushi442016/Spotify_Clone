  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
            <p className='bg-white text-black text-[15px] px-4 py-1 rounded-2xl hiddem md:block cursor-pointer'>Explore Premium</p>
            <p className='bg-black px-3 py-1 text-[15px] rounded-2xl cursor-pointer'>Install App</p>
            <p className='bg-purple-500 text-[#121212] h-7 w-7 rounded-full flex items-center justify-center'>D</p>
        </div>
    </div>
